...
Public Class SPUSamplingHandler
    ...
    Public Overloads Overrides Function ErrorMessage(ByVal err As EddErrors) As String
        Select Case err
            Case EddErrors.CustomError1
                Return "Parent_sample_code is required where sample_type_code= DUP, FSS, LSD, MS, MSD, and FDS. (1)"
            ...
            Case EddErrors.CustomError10
                Return "Coordinate_type cannot be null when coordinates have been entered (10)"
            Case Else
                Return ""
        End Select
    End Function
...
#Region "Error Codes"
    ...
    Friend Sub ERR9(ByVal e As System.Data.DataColumnChangeEventArgs)
        ...
        End With
    End Sub
    'ERR10 coordinate_type cannot be null when coordinates have been entered (10)
    Friend Sub ERR10(ByVal e As System.Data.DataColumnChangeEventArgs)
        Dim ss As String
        With e.Row
            If (Not .Item("x_coord") Is DBNull.Value) AndAlso (Not .Item("y_coord") Is DBNull.Value) Then
                If .Item("coordinate_type") Is DBNull.Value Then
                    Me.AddError(e.Row, .Table.Columns.Item("coordinate_type"), EddErrors.CustomError10)
                Else
                    Me.RemoveError(e.Row, .Table.Columns.Item("coordinate_type"), EddErrors.CustomError10)
                End If
            Else
                Me.RemoveError(e.Row, .Table.Columns.Item("coordinate_type"), EddErrors.CustomError10)
            End If
...
#Region "Create"
    ...
    Public Function GroupDesc_Outfall(ByVal eddRow As System.Data.DataRow, targetRow As System.Data.DataRow) As Boolean
        If (targetRow.Item("group_desc").ToString = "Outfall") Then
            Return (eddRow.Item("group_code").ToString)
        Else
            Return ""
        End If
    End Function

    Public Function HasCoordinates(ByVal eddRow As System.Data.DataRow) As Boolean
        If (eddRow.Item("x_coord") Is DBNull.Value) AndAlso (eddRow.Item("y_coord") Is DBNull.Value) Then
            Return False
        Else
            Return True
        End If
