' ''' <summary>
' '''   $Header: EDP/Formats/ESBasic/ESBasic.vb  16  2011-07-08 09:30:08-06:00  Bryce Mathews <bryce.mathews@earthsoft.com> $
...
Public Class ESBasicHandler
    ...
    Public Overrides Sub AddDataHandlers(ByRef Efd As EarthSoft.EDP.EddFormatDefinition)
        _efd = Efd
        Me.ESBasic = Efd.Tables(0)
        AddHandler ESBasic.ColumnChanged, AddressOf Me.ESBasic_ColumnChanged
    End Sub
    ...
    'KP_Case11563_20060703
    Public Sub ESBasic_ColumnChanged(ByVal sender As Object, ByVal e As System.Data.DataColumnChangeEventArgs)
...
#Region "Check"
    ...
    ''' Applies to:
    ''' <list type="bullet">
    '''   <item>ESBasic.Parent_Sample_Code</item>
    '''   <item>ESBasic.Sample_Type_Code</item>
    ''' </list>
    ''' </summary>
    ''' <history>
    ...
    ''' Applies to:
    ''' <list type="bullet">
    '''   <item>ESBasic.Analysis_Date</item>
    '''   <item>ESBasic.Sample_Date</item>
    ''' </list>
    ''' </summary>
    ''' <history>
    ...
    ''' <list type="bullet">
    '''   <item>ESBasic.Parent_Sample_Code</item>
    '''   <item>ESBasic.Sys_Sample_Code</item>
    ''' </list>
    ''' </summary>
    ''' <history>
...
#Region "Grid Events"
    Public Overrides Sub Grid_AfterCellUpdate(ByVal sender As Object, ByVal e As Object, ByVal edp As Object)
        If sender.Name.Equals("ESBasic") Then
