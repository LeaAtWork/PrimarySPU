USE [SEA_PU]
GO
/****** Object:  StoredProcedure [dbo].[SPU_TEC_Calc]    Script Date: 03/01/2013 13:02:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[SPU_TEC_Calc]
	(
		@facility_id int
		,@ND_mult float 
		,@SDG varchar (2000) 
...
BEGIN
	...
	,TEQ varchar(200),  cnt varchar (2000),SDG varchar (200), detect_flag varchar (20))
...
select 
	...
	,cast(t.analysis_date as date) as 'analysis_date'
	,cast(t.analysis_date as time) as	'analysis_time'
	,t.test_type
	,null as 'test_batch_id'
	,t.lab_sample_id
	,t.basis
